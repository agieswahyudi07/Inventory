        ...
        <div class="card-body">
            ...
            <form class="row g-3" action="saveAdd" method="post">
                ...
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" id="txtTypeCode" name="txtTypeCode" onkeyup="convertToUpperCase(this)" oninput="limitInputLength(this, 5)" value="<?= (!empty(session()->getFlashdata('txtTypeCode'))) ? session()->getFlashdata('txtTypeCode') : ""; ?>">
                </div>
                <div class="col-12">
                    <label for="inputNanme4" class="form-label">Type Name <span class="text-danger">*</span></label>
                    <input type="text" class="form-control " id="txtTypeName" name="txtTypeName" onkeyup="convertToUpperCase(this)" value="<?= (!empty(session()->getFlashdata('txtTypeName'))) ? session()->getFlashdata('txtTypeName') : ""; ?>" autofocus>
                </div>
