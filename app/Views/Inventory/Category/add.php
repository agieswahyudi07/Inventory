        ...
        <div class="card-body">
            ...
            <form class="row g-3" action="saveAdd" method="post">
                ...
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" id="txtCategoryCode" name="txtCategoryCode" onkeyup="convertToUpperCase(this)" oninput="limitInputLength(this, 5)" value="<?= (!empty(session()->getFlashdata('txtCategoryCode'))) ? session()->getFlashdata('txtCategoryCode') : ""; ?>">
                </div>
                <div class="col-12">
                    <label for="inputNanme4" class="form-label">Category Name <span class="text-danger">*</span></label>
                    <input type="text" class="form-control " id="txtCategoryName" name="txtCategoryName" onkeyup="convertToUpperCase(this)" value="<?= (!empty(session()->getFlashdata('txtCategoryName'))) ? session()->getFlashdata('txtCategoryName') : ""; ?>" autofocus>
                </div>
